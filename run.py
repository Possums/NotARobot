...
while(True):
    ...
    final_image.save('noisy.png')
    os.system('python3 config.py infer-image --image noisy.png --out finalimage.png --network-snapshot=network_final.pickle')
    ...
    y = json.loads(ocr_space_file('textimage.png', overlay=False, api_key='e899d8275688957', language='eng'))
